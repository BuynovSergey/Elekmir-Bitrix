...
$strReturn .= '<div class="hlebn-krohki" itemprop="http://schema.org/breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList"><ul>';
...
for($index = 0; $index < $itemSize; $index++)
{
	...
	$arrow = ($index > 0? '<li class="hlebn-krohki-dev">|</li>' : '');
	...
	if($arResult[$index]["LINK"] <> "" && $index != $itemSize-1)
	{
		$strReturn .=  $arrow.'
			<li class="bx-breadcrumb-item" id="bx_breadcrumb_'.$index.'" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
				'.(empty($index) ? '<img src="'.SITE_TEMPLATE_PATH.'/images/home.svg" class="ico-home" alt="На главную" title="На главную">' : '
