				...
				<div class="mb-3 basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?=$displayModeClass?>"
					...
					<div class="basket-items-list-container" id="basket-items-list-container">
						...
						<div class="basket-items-list" id="basket-item-list">
							...
							<div class="basket-items-list-table equipment">
                                <div class="thead">
                                    <?if(in_array('PREVIEW_PICTURE', $arParams['COLUMNS_LIST'])):?><div class="cart-item-image">Фото</div><?endif;?>
                                ...
                                <div class="tbody" id="basket-item-table"></div>
                            </div>
						</div>
					</div>
				</div>
