...
<script id="basket-item-template" type="text/html">
	<div class="tr basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
		...
		{{^SHOW_RESTORE}}
            <?if(in_array('PREVIEW_PICTURE', $arParams['COLUMNS_LIST'])):?>
                <div class="cart-item-image basket-items-list-item-images">
                <?
                if (in_array('PREVIEW_PICTURE', $arParams['COLUMNS_LIST']))
                {
                    ?>
            ...
            <?endif;?>
			<div class="cart-item-name basket-items-list-item-descriptions">
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-item-block-info">
						...
						{
							?>
							<span class="basket-item-actions-remove d-block d-md-none for-mobile" data-entity="basket-item-delete"></span>
							<?
						}
						?>
			...
			{
				?>
				<div class="cart-item-price basket-items-list-item-price basket-items-list-item-price-for-one">
			...
			?>
			<div class="cart-item-quantity basket-items-list-item-amount">
			...
			{
				?>
				<div class="cart-item-summa basket-items-list-item-price<?=(!isset($mobileColumns['SUM']) ? ' d-none d-sm-block' : '')?>">
			...
			{
				?>
				<div class="cart-item-actions basket-items-list-item-remove d-none d-md-block for-desctop">
					<div class="basket-item-block-actions">
						<span class="deleteitem icon icon-delete icon-18 icon-white icon-bg-blue icon-bg-30 icon-centered cursor" data-entity="basket-item-delete"></span>
						{{#SHOW_LOADING}}
							<div class="basket-items-list-item-overlay"></div>
						{{/SHOW_LOADING}}
					</div>
