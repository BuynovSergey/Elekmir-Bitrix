...
//$GLOBALS[$arParams["FILTER_NAME"]] = array_merge($arFilter, $arPreFilter);
...
<div class="row mb-4 <?=$arParams["TEMPLATE_THEME"]?>">
	<div class="<?=$contentBlockClass?>">
        ...
        <?
            ...
            ?>
				<?
				$intSectionID = $APPLICATION->IncludeComponent("bitrix:catalog.section", "main-list", array(
						"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
						"IBLOCK_ID" => $arParams["IBLOCK_ID"],
