...
<?if($_GET["new"]):?>
    ...
    <? if ($itemHasDetailUrl): ?>
        <a class="catalog-item" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>">
    <? else: ?>
        <div class="catalog-item">
    <? endif; ?>

        <div class="icon icon-heart catalog-item__favorite icon-centered icon-bg-circle" title="Отложить"></div>
        <div class="catalog-item__img">
            <?if($showSlider):?>
                ...
                ?>
            <?else:?>
                <img src="<?=($item['PREVIEW_PICTURE']['SRC'] ?: "/images/no-photo.jpg")?>" id="<?=$itemIds['PICT']?>" alt="" />
            <?endif;?>
        </div>
        <div class="catalog-item__title"><?=$productTitle?></div>
        <div>
            <div class="catalog-item__info">Артикул: - <?=$item["DISPLAY_PROPERTIES"]["ARTNUMBER"]["VALUE"]?></div>
            ...
            if (!empty($arParams['PRODUCT_BLOCKS_ORDER']))
            {
                foreach ($arParams['PRODUCT_BLOCKS_ORDER'] as $blockName)
                {
                    ...
                    {
                        case 'price': ?>
                            <div class="catalog-item__price-box" data-entity="price-block">
                                <div class="catalog-item__price js-catalog-price" id="<?=$itemIds['PRICE']?>">
                                    <?
                                    if (!empty($price))
                                    {
                                    ...
                                    ?>
                                    <span> <?=$actualItem['ITEM_MEASURE']['TITLE']?></span></div>
                            </div>
                            <?
                            break;
            ...
            <form action="">
                <input type="hidden" name="id" value="1008816"><input type="hidden" name="pr" value="456.96">

                <button class="btn btn-blue catalog-item__btn">
                    <div class="catalog-item__btn-text">В корзину</div>
                </button>
